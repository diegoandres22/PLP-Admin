...
export const NewCtaBankSection = () => {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Cédula/RIF y número de cuenta van como TEXTO: convertirlos a Number
      // perdía los ceros a la izquierda y redondeaba los números largos.
      const payload = {
        pay_method: formData.pay_method,
        holder_name_cta: formData.holder_name_cta || undefined,
        document_name: formData.document_name.trim() || undefined,
        number_cta_1: formData.number_cta_1.trim() || undefined,
